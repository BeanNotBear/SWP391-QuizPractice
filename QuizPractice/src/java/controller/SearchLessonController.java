...
@WebServlet(name = "SearchLessonController", urlPatterns = {"/searchLesson"})
public class SearchLessonController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("searchLesson") != null) {
            search = request.getParameter("searchLesson");
        }
        int page;
        ...
        session.setAttribute("searchLesson", search);
