...
@WebServlet(name = "AddPricePackageController", urlPatterns = {"/AddPricePackage"})
public class AddPricePackageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            SubjectPackagePriceDTO packagePriceDTO = new SubjectPackagePriceDTO(-1, 
                    name, 
                    duration, 
                    price,
                    price, 
            ...
            PricePackageDAO.getInstance().insert(packagePriceDTO);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
