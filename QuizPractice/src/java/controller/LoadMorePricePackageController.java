...
@WebServlet(name = "LoadMorePricePackageController", urlPatterns = {"/loadmorepackageprice"})
public class LoadMorePricePackageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String search = (String) session.getAttribute("searchPackage");
            session.setAttribute("pagePackage", page + 1);
