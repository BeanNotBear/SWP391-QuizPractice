    ...
    <section class="form-container">
        ...
        <form id="register-form" action="register" method="post">
            ...
            <div class="group-pass">
                ...
                <input onkeyup="validatePassword(this)" id="password-rg" type="password" name="password" placeholder="Password" required maxlength="20" class="box password" value="${requestScope.password}">
            ...
            <div class="group-cf-pass">
                ...
                <input onkeyup="checkPasswordAndCfPassword(this)" id="cfPasssword-rg" type="password" name="cf-password" placeholder="Confirm password" required maxlength="20" class="box cf-password" value="${requestScope.cfPassowrd}">
